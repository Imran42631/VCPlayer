...
async def repo(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/4d7a997a6c8c4eb406829.jpg",
  ...
  [𝐘𝐨𝐮𝐭𝐮𝐛𝐞](https://youtube.com/)""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🥀 𝐑𝐞𝐩𝐨 🥀", url=f"https://github.com")
            ],          
            [
                    InlineKeyboardButton(
                        "🥀 𝐏𝐫𝐨𝐦𝐨𝐭𝐢𝐨𝐧 🥀", url=f"https://t.me/PrimeNetworkCommunity")
                ],
                [
                    InlineKeyboardButton(
